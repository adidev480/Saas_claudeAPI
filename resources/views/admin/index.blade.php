                                    ...
                                    <div class="border-top border-dashed mt-2">
                                        <div class="row text-center align-items-center g-0">
                                            <div class="col-md-4 col-12">
                                                ...
                                                <img src="{{asset('backend/assets/images/cards/american-express.svg')}}" alt="user-card" height="36" />
                                                <img src="{{asset('backend/assets/images/cards/discover-card.svg')}}" alt="user-card" height="36" />
                                                <img src="{{asset('backend/assets/images/cards/mastercard.svg')}}" alt="user-card" height="36" />
                                            </div>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-md flex-shrink-0 me-2">
                                                                <span class="avatar-title bg-info-subtle rounded-circle">
                                                                    <img src="{{asset('backend/assets/images/products/logo/logo-2.svg')}}" alt="" height="22">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-md flex-shrink-0 me-2">
                                                                <span class="avatar-title bg-primary-subtle rounded-circle">
                                                                    <img src="{{asset('backend/assets/images/products/logo/logo-3.svg')}}" alt="" height="22">
                                                                </span>
                                                            </div>
                                                            <div>
                                        ...
                                        <table class="table table-custom align-middle table-nowrap table-hover mb-0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 85px;">
                                                        <div class="avatar-lg border rounded">
                                                            <img src="{{asset('backend/assets/images/products/p-1.png')}}" alt="Product-10" class="img-fluid rounded-2">
                                                        </div>
                                                    </td>
                                                    <td class="ps-0">
                                                ...
                                                <tr>
                                                    <td style="width: 85px;">
                                                        <div class="avatar-lg border rounded">
                                                            <img src="{{asset('backend/assets/images/products/p-2.png')}}" alt="Product-11" class="img-fluid rounded-2">
                                                        </div>
                                                    </td>
                                                    <td class="ps-0">
                                                ...
                                                <tr>
                                                    <td style="width: 85px;">
                                                        <div class="avatar-lg border rounded">
                                                            <img src="{{asset('backend/assets/images/products/p-3.png')}}" alt="Product-12" class="img-fluid rounded-2">
                                                        </div>
                                                    </td>
                                                    <td class="ps-0">
                                                ...
                                                <tr>
                                                    <td style="width: 85px;">
                                                        <div class="avatar-lg border rounded">
                                                            <img src="{{asset('backend/assets/images/products/p-4.png')}}" alt="Product-13" class="img-fluid rounded-2">
                                                        </div>
                                                    </td>
                                                    <td class="ps-0">
                                                ...
                                                <tr>
                                                    <td style="width: 85px;">
                                                        <div class="avatar-lg border rounded">
                                                            <img src="{{asset('backend/assets/images/products/p-5.png')}}" alt="Product-14" class="img-fluid rounded-2">
                                                        </div>
                                                    </td>
                                                    <td class="ps-0">
